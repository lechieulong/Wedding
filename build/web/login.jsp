        ...
        <div class="container">
            <div class="forms-container">
                <div class="signin-signup" style="display: flex;">
                    <form action="#" class="sign-in-form"   border: 5px #d33 solid; margin-left: 50px;">
                    ...
                    <form action="#" class="sign-up-form" style="margin-right: 100px;">
            ...
            <div class="panels-container">
                <div class="panel left-panel">
                    <div class="content"> 
                        <img alt="" src="" style="margin-bottom: 70px;margin-right: 50px;">
                        <button class="btn transparent" id="sign-up-btn" style="padding-bottom: 58px;">Sign up</button>
                    </div>
                    <img src="https://th.bing.com/th/id/OIP.z5kjsVRBpI6ktDBSsiLpBgHaJQ?pid=ImgDet&rs=1" class="image" alt="" />
                </div>
                <div class="panel right-panel">
                    <div class="content">
                        <img alt="" src="" style="width: 400px;margin-bottom: 18px; margin-left: 100px;">
